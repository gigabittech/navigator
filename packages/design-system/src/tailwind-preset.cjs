// CommonJS build of the Tailwind preset — used when the config is loaded via
// require() (e.g. jiti CJS context, postcss-load-config, tailwind config CJS).
// Keep this in sync with tailwind-preset.ts; the .ts file is the source of
// truth for types and IDE tooling.
